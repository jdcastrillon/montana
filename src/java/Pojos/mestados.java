...
//          transaccion=mestados.this.getConecion().transaccion(prepareInsert);
    ...
    public int edit() {
        int transaccion = -1;
        String prepareEdit = "update mestados set " + "descripcion=" + "'" + descripcion + "'" + "," + "estado=" + "'" + estado + "'" + " where " + "idEstado=" + idEstado;
        try {
            this.getConecion().con = this.getConecion().dataSource.getConnection();
            this.getConecion().con.setAutoCommit(false);
//           transaccion=mestados.this.getConecion().transaccion(prepareEdit);
    ...
    public int remove() {
        int transaccion = -1;
        String prepareDelete = "delete from  mestados where " + "idEstado=" + idEstado;
        try {
            this.getConecion().con = this.getConecion().dataSource.getConnection();
            this.getConecion().con.setAutoCommit(false);
