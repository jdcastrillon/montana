...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2018 a las 22:41:20
...
('Cajas', 1, 99999, 82, 1, 'A'),
('producto', 1, 1000, 75, 1, 'A');
...
CREATE TABLE `pedido` (
  ...
  `idPersonaTurno` int(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pedido` (`idPedido`, `idCliente`, `idPersonaCliente`, `FechaRegistro`, `FechaEntrega`, `idTurno`, `Usuario`, `Observacion`, `total_pedido`, `idPersonaTurno`) VALUES
...
(14, 1, 5, '2018-08-01 21:21:59', '2018-08-01 21:29:00', 33, 'admon', '', NULL, 0),
(15, 1, 5, '2018-08-01 22:01:46', '2018-08-01 22:06:22', 0, 'admon', '', NULL, 0);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateDespachoproducto` BEFORE INSERT ON `pedidovariables` FOR EACH ROW update despachoproducto desp
...
where dp.idDespacho = NEW.idDespacho and pv.idPedido = NEW.idPedido
and d.idTipoDespacho = 1
$$
DELIMITER ;
...
(6, 'Mauricio', 'Cliente', 'Mauricio Cliente', '1111111111', '1987-03-31', '', '2751245', '3156371573', 1, 'A');
...
--
ALTER TABLE `cajaproducto`
  MODIFY `idCajaProducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `cajas`
--
ALTER TABLE `cajas`
  MODIFY `idCaja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
