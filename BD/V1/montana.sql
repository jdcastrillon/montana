...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2018 a las 06:51:58
...
--
ALTER TABLE `hormasprod`
  MODIFY `idHormaProd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `insumoproducto`
--
ALTER TABLE `insumoproducto`
  MODIFY `idInsumoProducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `mcolores`
  MODIFY `idColor` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
