...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2018 a las 23:12:40
...
INSERT INTO `pedido` (`idPedido`, `idCliente`, `idPersona`, `FechaRegistro`, `FechaEntrega`, `Estado`, `idTurno`, `Usuario`, `Observacion`) VALUES
(2, 1, 5, '2018-07-18 05:00:00', '2018-07-25 05:00:00', 1, 1, 'admon', 'xxxx');
...
ALTER TABLE `despachoproducto`
  ADD PRIMARY KEY (`idDespachoProducto`,`idDespacho`,`idTurno`,`Usuario`,`idPersona`,`idCategoria`,`idProducto`),
