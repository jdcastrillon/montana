...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2018 a las 02:33:38
...
(5, 'admon', 1, '2018-06-28 12:00:00', 'A'),
(15, 'admon', 1, '2018-07-04 15:09:59', 'A');
...
--
ALTER TABLE `hormasprod`
  MODIFY `idHormaProd` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `insumoproducto`
--
ALTER TABLE `insumoproducto`
  MODIFY `idInsumoProducto` int(11) NOT NULL AUTO_INCREMENT;
